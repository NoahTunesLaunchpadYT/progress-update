...
conducted for each CFAR implementation on datasets D2, and D3. The performance (throughput, latency, 
...
be conducted across variations in SNR, and number of targets, in simulated data (D2) and pseudo-real data (D4). 
