...
The forth dataset is constructed to make up for the low availability of the third. It is a pseudo-real dataset 
that incorporates the clutter and noise characteristics from a recording of a stationary radar pointing at the 
empty sky and adds synthetic targets to it. 
...
\begin{table}[htbp]
    ...
    \begin{tabular}{|c|p{3cm}|p{5cm}|p{5cm}|}
        ...
        \hline
        DS4 & Validation under real-world clutter & Real data with simulated targets added. &
