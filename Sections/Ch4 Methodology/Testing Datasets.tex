...
While every component of the software can be tested with this first dataset, stages such as windowing
CFAR, angle sensing and track benefit from more realistic data. The choice of window heavily relies
