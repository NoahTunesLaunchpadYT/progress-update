...
coherency, eliminating the explicit transfer step. While this eliminates transfer cost,
it also means the CPU and GPU compete for memory bandwidth rather than drawing from 
separate pools, creating a risk of contention. 
