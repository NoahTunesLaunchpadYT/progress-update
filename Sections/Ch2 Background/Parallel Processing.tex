...
simultaneously, a pattern known as coalesced access. Non-coalesced access doesn't 
utilise memory bandwidth efficiently by not accessing contiguous memory locations. 
