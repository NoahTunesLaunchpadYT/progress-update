...
\begin{figure}[htb]
    \incfig[0.8]{mht}
    \label{fig:mht}
    \caption{Multiple hypothesis tracking algorithm maintaining branching tracks 
    ...
    for each target indicated by the large circles. 
    where 
    the targets are with the size
