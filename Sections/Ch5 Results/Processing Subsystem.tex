\section{Windowing}
The Hann and Hamming windows are first evaluated for the prominence of their main lobe and sidelobes
...
\begin{figure}
    ...
    \caption[Window filter comparison on a noise-free signal.]{Results of an FFT performed on a single frequency signal without noise without a filter,
...
\begin{figure}
    ...
    \caption[Window filter comparison at SNR of 1.]{Results of an FFT performed on a single frequency signal with an SNR of 1 with no
...
\begin{figure}
    ...
    \caption[Coherent integration on synthetic data showing SNR improvement.]{Results of the coherent integration stage on synthetic data.
...
\begin{figure}
    ...
    \caption[Coherent integration on AWR2243 test-source data.]{Results of the coherent integration stage on AWR2243 test-source data.
