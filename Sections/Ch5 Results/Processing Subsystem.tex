...
\begin{figure}
    ...
    the x-axis representing chirps that are streaming into the integrate stage. The 
...
\begin{figure}
    ...
    \caption{Results of the coherent integration stage on AWR2243 test-source data. 
