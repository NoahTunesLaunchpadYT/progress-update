...
\begin{figure}
    ...
    detections. The spread of the dots increase as range increases as expected, and the 
    upper and lower bounds of 
    elevation and bearing meet expectations 
    based on the polynomial chosen for the angle sensing algorithm.}
...
\begin{figure}
    ...
    \caption{Latency of the subsystem running CFAR, angle sensing, and both on a log scale. 
...
\begin{figure}
    ...
    \caption{A breakdown of the latency of the subsystem estimated from the ablation study. 
