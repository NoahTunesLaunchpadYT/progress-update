...
\gls{uav}s, which parallel the \gls{vfr} \& \gls{ifr} that dictate
...
modality. Acoustic detection has also been explored for UAV DAA, but its 
short effective range makes it unsuitable for the well clear zone requirements 
of ASTM F3442/F3442M-23.
